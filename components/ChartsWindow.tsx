...
import basicStrategy from '@/public/data/basicStrategy.json';
import countDeviations from '@/public/data/countDeviations.json';

// A generic component to render a strategy chart table

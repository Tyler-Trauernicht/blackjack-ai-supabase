...
const UpgradePrompt = () => (
  <div className="text-center p-8 bg-gray-800 rounded-lg max-w-2xl mx-auto">
    ...
    <p className="text-gray-400 mb-6">Upgrade to Pro to access the Deviation Trainer and other advanced features.</p>
...
export default async function DeviationsPage() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-8 text-center">Deviation Training</h1>
      <DeviationsWindow />
    </div>
  );
}
